...
if (score / possible >= .80){return "B"}
if (score / possible >= .70){return "C"}
if (score / possible >= .60){return "D"}
else return "F"
...
let fever = "fever"
let warning= " go to hospital"
let no= "no "
    if (temp >= 103){return fever.concat(warning)}
    if (temp >= 98.7){return fever}
    else return no.concat(fever)
}
